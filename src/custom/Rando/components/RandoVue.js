...
export default class RandoVue extends Component {
    /**
    ...
    constructor(component, options, data) {
        ...
        const vueApp = Vue.extend(Counter);

        this.counter = new vueApp({
            propsData: {
                value: 5
            }
        });

        this.counter.$on('input', () => {
            this.updateValue()
        });
    }
    ...
    attach(element) {
        ...
        this.counter.$mount(this.refs.customRef);
